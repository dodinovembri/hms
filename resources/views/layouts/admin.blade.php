...
<html>
  <head>
    ...
    <link href="{{ asset('tmp/assets/plugins/nvd3/nv.d3.min.css') }}" rel="stylesheet" type="text/css" media="screen" />
    <link href="{{ asset('tmp/assets/plugins/mapplic/css/mapplic.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('tmp/assets/plugins/rickshaw/rickshaw.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('tmp/assets/plugins/bootstrap-datepicker/css/datepicker3.css') }}" rel="stylesheet" type="text/css" media="screen">
    <link href="{{ asset('tmp/assets/plugins/jquery-metrojs/MetroJs.css') }}" rel="stylesheet" type="text/css" media="screen" />
  ...
  <body class="fixed-header dashboard  windows desktop pace-done sidebar-visible menu-pin">
    ...
    <script src="{{ asset('tmp/assets/plugins/nvd3/lib/d3.v3.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/nv.d3.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/utils.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/tooltip.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/interactiveLayer.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/models/axis.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/models/line.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/nvd3/src/models/lineWithFocusChart.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/mapplic/js/hammer.js') }}"></script>
    <script src="{{ asset('tmp/assets/plugins/mapplic/js/jquery.mousewheel.js') }}"></script>
    <script src="{{ asset('tmp/assets/plugins/mapplic/js/mapplic.js') }}"></script>
    <script src="{{ asset('tmp/assets/plugins/rickshaw/rickshaw.min.js') }}"></script>
    <script src="{{ asset('tmp/assets/plugins/jquery-metrojs/MetroJs.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/jquery-sparkline/jquery.sparkline.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/skycons/skycons.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js') }}" type="text/javascript"></script>
    <!-- END VENDOR JS -->
    <!-- BEGIN CORE TEMPLATE JS -->
    <script src="{{ asset('tmp/pages/js/pages.min.js') }}"></script>
    <!-- END CORE TEMPLATE JS -->
    <!-- BEGIN PAGE LEVEL JS -->
    <script src="{{ asset('tmp/assets/js/dashboard.js') }}" type="text/javascript"></script>
    <script src="{{ asset('tmp/assets/js/scripts.js') }}" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS -->
  </body>
</html>